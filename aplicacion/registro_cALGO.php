		...
		<div class="title"><h2>Registro de Cliente</h2></div>
			<form  name= "form1" method="post" action="registro_c.php" class="agregcliente" style="font-size:14px;font-family:Arial;color:#34495E;min-width:150px">
				...
				<article>
					...
					<p><input  placeholder="Nombre" title="Introduzca un Nombre Valido" type="text" size= "14px" name="nombre_c"  autofocus required pattern="[a-zA-Z--]*" /></p>
					
					<p><input placeholder="Apellido"  title="Introduzca un Apellido Valido" type="Text" size= "14px" name="apellido_c"  required  pattern="[a-zA-Z]*" /></p>
					...
					<p><input placeholder="Direcci&oacute;n"  title="Introduzca una direcci&oacute;n Valida" type="Text" size= "40px" name="direccion" required pattern="[a-zA-Z-  ]*"></p>
					<p>
