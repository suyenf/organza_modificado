...
<html lang="es">
	...
	<body>
			...
			<!--<div class="title">--></br>
				...
				<p><h2><a href="respaldo.php"  style="position:absolute;top:189px;left:997px;border-radius:10;"class="linkrespaldo">Generar Respaldo</a></h2></p>
				<?php
					...
					//print_r($lista);
				?>
				<table style="position:absolute;top:209px;left:197px;border-radius:10;" width="100" border="4">
