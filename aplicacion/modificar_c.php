...
<section id="trabajos">
        ...
        <article>            
                <nav>	               
				    	<form name="form3" method="post" action="" class="modificarxliente"  style="font-size:14px;font-family:Arial bold;min-width:150px">
					  ...
					  <label>Apellido:</label><input type="Text" size= "14px" name="apellido" value="<?php echo $cliente['apellido_c'];?>" required  pattern="[a-zA-Z- - -]*" /></p>
				   </br>  </br>  </br>
					  <label>C&eacute;dula</label><input  type="id" name="ci" value="<?php echo $cliente['ci'];?>"required pattern="\d\d\d\d\d\d\d\d" title="Introduzca 8 digitos y Si la Cédula contiene 7 coloque 0"></p></br></br>  </br>
	                   <label>Direcci&oacute;n:</label><input type="Text" size= "40px" name="direccion" value="<?php echo $cliente['direccion'];?>"required pattern="[a-zA-Z-0-9- - - ]*"></p> </br></br>  </br>
					   <label>Tel&eacute;fono</label><input type="tel" id="orderTelephone" name="telefono" value="<?php echo $cliente['telefono'];?>"pattern="[0-9-/]*" title="Introduzca solo números" /></br></br></br>
